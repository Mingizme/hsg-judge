...
export function ProblemTabs({ pdfUrl, problemCode, onApplyCode }: ProblemTabsProps) {
  return (
    <TabsPrimitive.Root defaultValue="pdf" className="flex flex-col h-full w-full">
      <TabsPrimitive.List className="flex w-full items-center border-b px-2 h-10 bg-muted/30 shrink-0">
